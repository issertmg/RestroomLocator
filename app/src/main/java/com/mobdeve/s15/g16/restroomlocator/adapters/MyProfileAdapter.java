...
public class MyProfileAdapter extends FirestoreRecyclerAdapter<Review, MyReviewViewHolder> {

    private Context context;

    public MyProfileAdapter(FirestoreRecyclerOptions<Review> options, Context context) {
        super(options);
    ...
    public void onDataChanged() {
        super.onDataChanged();
        ((UserProfileActivity) context).setTvNumReviews(getItemCount());
    }
}
